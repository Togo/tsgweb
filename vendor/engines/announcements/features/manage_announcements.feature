...
Feature: Announcements
  ...
  Scenario: Create Valid Announcement
    ...
    And I fill in "League" with "This is a test of the first string field"
    And I press "Save"
    Then I should see "'This is a test of the first string field' was successfully added."
    And I should have 1 announcement

  @announcements-invalid @invalid
  Scenario: Create Invalid Announcement (without league)
    When I go to the list of announcements
    And I follow "Add New Announcement"
    And I press "Save"
    Then I should see "League can't be blank"
    And I should have 0 announcements

  @announcements-edit @edit
  Scenario: Edit Existing Announcement
    Given I have announcements titled "A league"
    When I go to the list of announcements
    And I follow "Edit this announcement" within ".actions"
    Then I fill in "League" with "A different league"
    And I press "Save"
    Then I should see "'A different league' was successfully updated."
    And I should be on the list of announcements
    And I should not see "A league"
  ...
  Scenario: Create Duplicate Announcement
    ...
    When I go to the list of announcements
    And I follow "Add New Announcement"
    And I fill in "League" with "UniqueTitleTwo"
    And I press "Save"
